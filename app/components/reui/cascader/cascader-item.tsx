...
const ROW_INSET_CLASS = "[--cascader-row-inset:12px]";
...
const ROW_THEME_CLASS =
  "data-highlighted:bg-accent data-highlighted:text-accent-foreground not-data-[variant=destructive]:data-highlighted:**:text-accent-foreground [&_svg:not([class*='size-'])]:size-4 py-2 rounded-2xl font-medium";
...
const CASCADER_LABEL_CLASS = `text-muted-foreground text-xs py-2.5 ${CASCADER_ACTION_INSET_CLASS} block truncate`;
...
const CASCADER_SEPARATOR_CLASS =
  "h-px bg-border my-1.5 mx-[calc(var(--cascader-list-pad,4px)*-1)]! shrink-0";
