    ...
    if (currentGroupStart > 0) {
      return (
        <Button
          ...
          variant="ghost"
          aria-label={`Go to pages before ${currentGroupStart + 1}`}
    ...
    if (currentGroupEnd < pageCount) {
      return (
        <Button
          ...
          variant="ghost"
          size="icon-sm"
          aria-label={`Go to page ${currentGroupEnd + 1}`}
    ...
    >
      <div className="order-2 flex flex-wrap items-center space-x-2.5 pb-2.5 sm:order-1 sm:pb-0">
        {isLoading ? (
          ...
          <>
            <div id={rowsPerPageLabelId} className="text-muted-foreground text-sm">
            ...
            >
              <SelectTrigger className="w-16" size="sm" aria-labelledby={rowsPerPageLabelId}>
                <SelectValue />
              </SelectTrigger>
              <SelectContent
                align="start"
