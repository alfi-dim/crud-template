...
export function createFilterDraft<V = unknown>(cascaderPath: string[] = []): FilterDraft<V> {
  return {
    step: "field",
    status: "editing",
    ruleId: null,
 ...
 */
export function isFilterDraftCommittable<V>(draft: FilterDraft<V> | null): draft is FilterDraft<V> {
